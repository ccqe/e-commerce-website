...
import {rimSubSrc,rimGoods} from './data'

export default class RimBar extends Component{
	state={
        currentContent:0
    }
		...
		return(
				...
				<h1 className="list_title">周边
					<ul>
						...
						onMouseOver={()=>this.changeContent(1)}><a href="#">出行</a></li>
					</ul>
				</h1>
				<div className="wiring_left">
					<a href="#"><img src={rimSubSrc[0]}/></a>
					<a href="#"><img src={rimSubSrc[1]}/></a>
				</div>
				<div className="wiring_right">		
                    {
                        rimGoods.map((item,index)=>{
                            return(
