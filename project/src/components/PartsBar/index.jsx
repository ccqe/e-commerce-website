...
import {partsSubSrc,partsGoods} from './data'

export default class PartsBar extends Component{
	state={
        currentContent:0
    }
		...
		return(
				...
				<h1 className="list_title">配件
					<ul>
						...
						onMouseOver={()=>this.changeContent(1)}><a href="#">充电器</a></li>
					</ul>
				</h1>
				<div className="wiring_left">
					<a href="#"><img src={partsSubSrc[0]}/></a>
					<a href="#"><img src={partsSubSrc[1]}/></a>
				</div>
				<div className="wiring_right">		
                    {
                        partsGoods.map((item,index)=>{
                            return(
